...
public static class IEventTargetInProcessExtensions
{
    ...
    public static void AddEventListener<TInProcessEvent, TEvent>(this IEventTargetInProcess eventTarget,
        IJSInProcessObjectReference inProcessHelper, string type,
        EventListenerInProcess<TInProcessEvent, TEvent>? callback, AddEventListenerOptions? options = null)
    ...
    public static void AddEventListener<TInProcessEvent, TEvent>(this IEventTargetInProcess eventTarget,
        IJSInProcessObjectReference inProcessHelper, EventListenerInProcess<TInProcessEvent, TEvent>? callback,
        AddEventListenerOptions? options = null)
        where TEvent : Event, IJSCreatable<TEvent>
        where TInProcessEvent : IJSInProcessCreatable<TInProcessEvent, TEvent>
    {
        inProcessHelper.InvokeVoid("addEventListener", eventTarget.JSReference, typeof(TEvent).Name,
            callback?.JSReference, options);
    }
    ...
    public static void RemoveEventListener<TInProcessEvent, TEvent>(this IEventTargetInProcess eventTarget,
        IJSInProcessObjectReference inProcessHelper, string type,
        EventListenerInProcess<TInProcessEvent, TEvent>? callback, EventListenerOptions? options = null)
        where TEvent : Event, IJSCreatable<TEvent>
        where TInProcessEvent : IJSInProcessCreatable<TInProcessEvent, TEvent>
    {
        inProcessHelper.InvokeVoid("removeEventListener", eventTarget.JSReference, type, callback?.JSReference,
            options);
    }
    ...
    public static void RemoveEventListener<TInProcessEvent, TEvent>(this IEventTargetInProcess eventTarget,
        ...
        where TInProcessEvent : IJSInProcessCreatable<TInProcessEvent, TEvent>
    {
        inProcessHelper.InvokeVoid("removeEventListener", eventTarget.JSReference, typeof(TEvent).Name,
            callback?.JSReference, options);
    }
